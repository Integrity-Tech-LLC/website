    ...
    <>
      <div
        ...
        <div className={styles.banner}>
          ...
          <p className={styles.bannerText}>
            ...
            not listed in the agreed upon package are charged per cost of
            service. All additional maintenance service hours outside of the
            agreed upon plan are charged at $200 an hour.
          </p>
        </div>
      </div>
      <div className={styles.container}>
        ...
        <ul className={styles.text}>
          ...
          <li>Free website and monitoring</li>
      ...
      <div className={styles.container}>
        ...
        <ul className={styles.text}>
          ...
          <li>Up to 12 free service hours per month</li>
        </ul>
      </div>
    </>
  );
